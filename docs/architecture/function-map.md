...
`dist/app.js`, criada em `TITO-FUNCTION-MAP-001` e atualizada pela tarefa
`TITO-CITY-INTEL-001`.

- SHA-256 mapeado: `8b3e591b0a1d32e3c80346d44da1fb326824896f1cd68dd68009aad6be68ca7e`
- Unidades executáveis: **58**
- Ocorrências de `function`: **25**
- Arrow functions: **33**
...
| `FN-002` | `loadGame` | 5 | Carregar, validar e ativar um caso. |
| `FN-003` | `fresh` | 6 | Criar o estado inicial da partida. |
| `FN-004` | `save` | 7 | Persistir a investigação atual. |
| `FN-005` | `loc` | 7 | Resolver uma cidade por ID. |
| `FN-006` | `ev` | 7 | Resolver uma evidência por ID. |
...
| `FN-020` | `newCase` | 20 | Reiniciar a investigação, preservando carreira. |
...
| `CB-009` | `place.renderAction` | 11 | Projetar ação investigativa. |
...
| `CB-030` | `events.resetCase` | 22 | Reiniciar a investigação após confirmação. |
...
inicialização/importação
  FN-002 loadGame → FN-003 fresh? → FN-007 render
...
| --- | --- |
| Interface | `FN-001`, `FN-007`–`FN-013`, `FN-016`–`FN-018`, `FN-020`–`FN-025`, `CB-004`–`CB-014`, `CB-017`, `CB-018`, `CB-022`–`CB-032` |
| Estado da partida | `FN-002`–`FN-004`, `FN-007`, `FN-014`, `FN-015`, `FN-017`, `FN-019`, `FN-020`, `CB-014`, `CB-029`, `CB-030`, `CB-031` |
| Persistência | `FN-002`, `FN-004`, `FN-014`, `FN-015`, `FN-017`–`FN-020`, `CB-014`, `CB-029`, `CB-030` |
| `game.json` e dados | `FN-002`, `FN-003`, `FN-005`, `FN-006`, `FN-008`–`FN-019`, `CB-001`–`CB-004`, `CB-007`–`CB-022`, `CB-031` |
| Navegação | `FN-003`, `FN-005`, `FN-009`, `FN-010`, `FN-012`–`FN-015`, `CB-002`, `CB-004`–`CB-011`, `CB-013`, `CB-014` |
| Evidências | `FN-003`, `FN-006`, `FN-010`, `FN-011`, `FN-014`, `FN-016`, `CB-003`, `CB-009`–`CB-012`, `CB-015`, `CB-016` |
...
âncoras e linhas atuais, presença de cada ID nesta visão humana e paridade entre
as 25 ocorrências de `function`, as 33 arrow functions e as 58 entradas do mapa.
