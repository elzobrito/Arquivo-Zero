...
export function eq(actual, expected, ctx) {
...
export function neq(actual, expected, ctx) {
...
export function contains(actual, expected, ctx) {
  if (isAbsent(actual)) {
...
export function inOp(actual, expected, ctx) {
  if (isAbsent(actual)) {
...
export function notIn(actual, expected, ctx) {
...
export function range(actual, expected, ctx) {
  if (isAbsent(actual)) {
