...
try {
  loadedService = require("../../domain/hypotheses/hypothesis-service.js");
} catch (error) {
  loadedService = null;
}
...
module.exports = {
  renderHypothesisBoard: renderHypothesisBoard,
  buildHypothesisBoardHTML: buildHypothesisBoardHTML,
  createHypothesisBoardController: createHypothesisBoardController,
};
