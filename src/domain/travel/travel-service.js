"use strict";
const { isUnaffordable, debitHours } = require("../time/time-service.js");

function canTravel(state, game, destinationId, navigation) {
...
function applyTravel(state, game, destinationId, navigation) {
...
module.exports = { canTravel, applyTravel };
