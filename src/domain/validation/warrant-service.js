...
const { filterSuspects } = require("../dossier/dossier-service.js");
const { calculateStrength } = require("../hypotheses/evidence-strength.js");
const { canSupportArrest } = require("../evidence/evidence-policy.js");
...
function requestWarrant(state, game, chosen) {
